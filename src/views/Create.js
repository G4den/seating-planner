            ...
            <div className={"flex flex-col space-y-8 items-center"}>
                <div className={"flex flex-col space-y-5 items-center"}>
                    ...
                    <div className={"flex  justify-between items-end space-x-2"}>
                        <input autoFocus={true} spellCheck={false} type={"name"} value={currentName} onChange={e => setCurrentName(e.target.value)} className={"w-72 h-14 rounded-xl text-2xl outline-none border-2 border-black text-center  "}/>
